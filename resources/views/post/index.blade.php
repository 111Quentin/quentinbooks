            ...
            <div>
                ...
                <div class="blog-post">
                   ...
                   {!!str_limit($post->content,500,'...')!!}
                    <p class="blog-post-meta"><a href="/posts/{{$post->id}}" ><span class="glyphicon glyphicon-heart-empty"></span>赞 {{$post->zans_count}}</a> | <a href="/posts/{{$post->id}}" ><span class="glyphicon glyphicon-comment"></span>评论{{$post->comments_count}}</a></p>
                </div>
                @endforeach
               {{$posts->links()}}
            </div><!-- /.blog-main -->
