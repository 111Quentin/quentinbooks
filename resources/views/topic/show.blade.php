...
@section("content")
    ...
    <div class="col-sm-8">
        <blockquote>
            ...
            <button class="btn btn-primary topic-submit"  data-toggle="modal" data-target="#topic_submit_modal" topic-id="{{$topic->id}}" _token="{{csrf_token()}}" type="button">投稿</button>
        </blockquote>
    </div>
                ...
                <div class="tab-pane active" id="tab_1">
                    @foreach($posts as $post)
                        <div class="blog-post" style="margin-top: 30px">
                            <?php \Carbon\Carbon::setLocale('ch');?>
