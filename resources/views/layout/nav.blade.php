<div class="blog-masthead ">
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <div>
                    <a href="/user/{{\Auth::id()}}/setting"><img src="{{\Auth::User()->avatar}}" alt="" class="img-rounded" style="border-radius:500px; height: 30px"></a>
                    <a href="#" class="bt dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
