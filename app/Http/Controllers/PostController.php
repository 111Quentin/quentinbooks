...
class PostController extends Controller
{
    ...
    {
      //验证
     $this->validate(request(),['title'=>'required|string|max:100|min:5',
    ...
    {
        //验证
        $this->validate(request(),['title'=>'required|string|max:100|min:2','content'=>'required|string|min:1']);
